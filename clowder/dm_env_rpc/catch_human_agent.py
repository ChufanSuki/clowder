...
from dm_env_rpc.v1 import dm_env_adaptor, dm_env_rpc_pb2, dm_env_rpc_pb2_grpc
...
def main(_):
    ...
    with dm_env_rpc_connection.create_secure_channel_and_connect(f"localhost:{port}") as connection:
        env, world_name = dm_env_adaptor.create_and_join_world(connection, create_world_settings={}, join_world_settings={})
        with env:
